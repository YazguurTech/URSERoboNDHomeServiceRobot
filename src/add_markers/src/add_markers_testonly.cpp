...
int main( int argc, char** argv )
{
  ...
  while (ros::ok())
  {
    visualization_msgs::Marker marker1 = GetMarker(4.75, -6.25);
    ...
    ROS_INFO("Publishing the first marker.");
    ...
    visualization_msgs::Marker marker2 = GetMarker(-3.5, 5.8);

    ROS_INFO("Publishing the second marker.");
