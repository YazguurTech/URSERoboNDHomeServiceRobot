...
int main(int argc, char** argv){
  ...
  nh.getParam("/pickup_location/px", pickup_location_x);
  nh.getParam("/pickup_location/py", pickup_location_y);
  nh.getParam("/dropoff_location/px", dropoff_location_x);
  nh.getParam("/dropoff_location/py", dropoff_location_y);
  ...
  goal.target_pose.pose.position.x = pickup_location_x;
  goal.target_pose.pose.position.y = pickup_location_y;
  ...
  goal.target_pose.pose.position.x = dropoff_location_x;
  goal.target_pose.pose.position.y = dropoff_location_y;
  goal.target_pose.pose.orientation.w = 1.0;
